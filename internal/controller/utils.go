...
const (
	...
	// flow action
	ERROR_FLAG_CAN_NOT_GET_WORKFLOW         = "ERROR_FLAG_CAN_NOT_GET_WORKFLOW"
	ERROR_FLAG_CAN_NOT_CREATE_WORKFLOW      = "ERROR_FLAG_CAN_NOT_CREATE_WORKFLOW"
	ERROR_FLAG_CAN_NOT_UPDATE_WORKFLOW      = "ERROR_FLAG_CAN_NOT_UPDATE_WORKFLOW"
	ERROR_FLAG_CAN_NOT_DELETE_WORKFLOW      = "ERROR_FLAG_CAN_NOT_DELETE_WORKFLOW"
	ERROR_FLAG_EXECUTE_WORKFLOW_FAILED      = "ERROR_FLAG_EXECUTE_WORKFLOW_FAILED"
	ERROR_FLAG_CAN_NOT_PARSE_EXPIRE_AT_TIME = "ERROR_FLAG_CAN_NOT_PARSE_EXPIRE_AT_TIME"
	ERROR_FLAG_CAN_NOT_PROCESS_WORKFLOW     = "ERROR_FLAG_CAN_NOT_PROCESS_WORKFLOW"
)
